...
REMOTE_MAVEN_PACKAGES = [
        ...
        ('com.amazonaws', 'aws-java-sdk-dynamodb', '1.11.90'),
        ('com.amazonaws', 'aws-java-sdk-s3', '1.11.90'),
        ('com.amazonaws', 'aws-java-sdk-kms', '1.11.90'),
        ('com.amazonaws', 'aws-java-sdk-core', '1.11.90'),
        ...
        ('com.amazonaws', 'aws-java-sdk-kinesis', '1.11.90'),
        ('com.amazonaws', 'aws-java-sdk-cloudwatch', '1.11.90'),
